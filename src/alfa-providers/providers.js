// Auto-fixed providers - generated by _fix_providers.js
...
module.exports = [
  ...
  },
  {
    ...
    language: ['lat'],
    active: false, // DEAD_DOMAIN: no response
    adult: false,
  ...
  },
  {
    ...
    language: ['cast'],
    active: true, // search usa POST /buscar, Anubis PoW bypass integrado
    adult: false,
  ...
  },
  {
    ...
    active: true,
    adult: false,
    search: { url: '/?s={query}', itemSelector: 'div.embla__slide_carousel', titleSelector: 'img[alt]', linkSelector: 'a', titleAttr: 'alt' }, // <-- fixed
    videos: { type: 'iframe', containerSelector: '.entry-content', iframeSelector: 'iframe', defaultQuality: 'HD' }
  },
  {
    name: 'doramedplay',
    ...
    active: true,
    adult: false,
    search: { url: '/?s={query}', itemSelector: 'li', titleSelector: 'h2', linkSelector: 'a' }, // <-- fixed
    videos: { type: 'iframe', containerSelector: '.entry-content', iframeSelector: 'iframe', defaultQuality: 'HD' }
  },
  {
  ...
  },
  {
    ...
    active: true,
    adult: false,
    search: { url: '/?s={query}', itemSelector: 'div.jeg_content', titleSelector: 'img[alt]', linkSelector: 'a', titleAttr: 'alt' }, // <-- fixed
    videos: { type: 'iframe', containerSelector: '.entry-content', iframeSelector: 'iframe', defaultQuality: 'HD' }
  },
  {
    name: 'gnula',
  ...
  },
  {
    ...
    categories: ['movie', 'tvshow', 'vos'],
    language: ['cast', 'lat'],
    active: false, // JS-dependiente, necesita Puppeteer
    adult: false,
    search: { url: '/?s={query}', itemSelector: 'article', titleSelector: 'h2', linkSelector: 'a' },
  ...
  },
  {
    ...
    active: true,
    adult: false,
    search: { url: '/?s={query}', itemSelector: 'article', titleSelector: 'a[title]', linkSelector: 'a', titleAttr: 'title' }, // <-- fixed
    videos: { type: 'iframe', containerSelector: '.entry-content', iframeSelector: 'iframe', defaultQuality: 'HD' }
  },
  {
    name: 'mitorrent',
    ...
    categories: ['movie', 'tvshow', 'torrent'],
    language: ['lat'],
    active: false, // JS-dependiente, shortener anti-bot
    adult: false,
  ...
  },
  {
    ...
    categories: ['movie'],
    language: ['lat', 'cast'],
    active: true, // CLOUDFLARE_TURNSTILE: necesita Scrapeless API key
    adult: false,
    search: { url: '/?s={query}', itemSelector: 'article', titleSelector: 'h2', linkSelector: 'a' },
    videos: { type: 'iframe', containerSelector: '.entry-content', iframeSelector: 'iframe', defaultQuality: 'HD' }
  },
  ...
  },
  {
    ...
    active: true,
    adult: false,
    search: { url: '/?s={query}', itemSelector: 'li.peli_bx', titleSelector: 'h2', linkSelector: 'a' }, // <-- fixed
    videos: { type: 'iframe', containerSelector: 'body', iframeSelector: 'iframe', defaultQuality: 'HD', srcAttr: 'data-src' } // <-- fixed
  },
  {
    name: 'wolfmax4k',
    title: 'WolfMax4K',
  ...
  },
  {
    ...
    categories: ['movie', 'tvshow'],
    language: ['lat'],
    active: false, // DEAD_DOMAIN: no response (403 Cloudflare)
    adult: false,
    search: { url: '/?s={query}', itemSelector: 'article', titleSelector: 'h2', linkSelector: 'a' },
    videos: { type: 'iframe', containerSelector: '.entry-content', iframeSelector: 'iframe', defaultQuality: 'HD' }
  },
  {
    ...
    categories: ['movie', 'vos'],
    language: ['lat', 'cast'],
    active: false, // JS-dependiente, requiere browser
    adult: false,
    search: { url: '/?s={query}', itemSelector: 'article', titleSelector: 'h2', linkSelector: 'a' },
    videos: { type: 'iframe', containerSelector: '.entry-content', iframeSelector: 'iframe', defaultQuality: 'HD' }
  },
  ...
  },
  {
    ...
    categories: ['anime'],
    language: ['cast', 'lat', 'vose'],
    active: false, // REDUNDANT: ya implementado en src/anime/scrapers/animeflv.js (Puppeteer nativo)
    adult: false,
  ...
  },
  {
    ...
    categories: ['anime'],
    language: ['cast', 'lat', 'vose'],
    active: false, // REDUNDANT: ya implementado en src/anime/scrapers/animejara.js (Puppeteer+Cheerio nativo)
    adult: false,
  ...
  },
  {
    ...
    categories: ['anime'],
    language: ['cast', 'lat'],
    active: true, // reactivado, selectores necesitan update
    adult: false,
  ...
  },
  {
    ...
    active: true,
    adult: false,
    search: { url: '/search?keyword={query}', itemSelector: 'a.film-poster-ahref', titleSelector: 'a[title]', titleAttr: 'title', linkSelector: '&' }, // <-- fixed
    videos: { type: 'iframe', containerSelector: 'body', iframeSelector: 'iframe', defaultQuality: 'HD', srcAttr: 'src' } // <-- fixed
  },
  {
    name: 'hacktorrent',
  ...
  },
  {
    ...
    categories: ['anime'],
    language: ['cast', 'lat', 'vose'],
    active: false, // REDUNDANT: ya implementado en src/anime/scrapers/jkanime.js (Puppeteer nativo)
    adult: false,
  ...
  },
  {
    ...
    language: ['lat'],
    active: false, // TioPlus: search redirects, only 9KB HTML, necesita update de selectores
    adult: false,
  ...
  },
  {
    ...
    categories: ['anime', 'vos'],
    language: ['cast', 'lat', 'vose'],
    active: false, // REDUNDANT: ya implementado en src/anime/scrapers/tioanime.js (Puppeteer nativo)
    adult: false,
  ...
  },
  {
    ...
    active: true,
    adult: false,
    search: { url: '/animes?buscar={query}', itemSelector: 'div.accordion-item', titleSelector: 'h2', titleAttr: 'alt', linkSelector: 'a' }, // <-- fixed
    videos: { type: 'jsvar', varPattern: /var videos = (\[.*?\]);/, defaultQuality: 'HD' }
  },
  {
    name: 'veranime',
    ...
    categories: ['anime'],
    language: ['cast', 'lat', 'vose'],
    active: false, // DEAD_DOMAIN: no response (403)
    adult: false,
    search: { url: '/?s={query}', itemSelector: 'article', titleSelector: 'h2', linkSelector: 'a' },
    videos: { type: 'jsvar', varPattern: /var videos = (\[.*?\]);/, defaultQuality: 'HD' }
  },
  ...
  },
  {
    ...
    categories: ['documentary'],
    language: ['cast', 'lat'],
    active: true, // JS-dependiente, requiere browser
    adult: false,
